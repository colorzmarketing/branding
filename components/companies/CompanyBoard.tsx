...
const PIPELINE: { status: CompanyStatus; label: string; color: string }[] = [
  { status: "미컨택",   label: "미컨택",   color: "border-gray-300" },
  { status: "컨택중",   label: "컨택중",   color: "border-yellow-400" },
  { status: "협의중",   label: "협의중",   color: "border-blue-400" },
  { status: "계약완료", label: "계약완료", color: "border-green-400" },
  { status: "종료",     label: "종료",     color: "border-red-300" },
];
